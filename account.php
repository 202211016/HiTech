		 ...
		 <div class="registration_left">
			 ...
			 <!-- Form -->
				<form id="registration_form" action="#" method="post">
					...
					<div>
						<label>
							<input placeholder="last name:" type="text" tabindex="2" name="lname" required autofocus>
						</label>
					</div>
					<div>
						<label>
					...
					<div>
						<label>
							<input placeholder="Mobile:" type="text" tabindex="3" name="mob" required>
					...
					<!--<div>
						<label>
							<input placeholder="retype password" type="password" tabindex="4" name="rpwd" required>
						</label>
					</div-->	
					<div>
						<input type="submit" value="create an account" id="register-submit" name="signup">
					</div>
	 ...
	 <div class="container">
		 <div class="shpng-grids">
			 <div class="col-md-4 shpng-grid">
				 <h3>Shipping charges will be tanken on order weight</h3>
				 <p>On Order Over </p>
			 </div>
			 <div class="col-md-4 shpng-grid">
				 <h3>Order Return</h3>
